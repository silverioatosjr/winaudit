    ...
    public class AccountController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    if(roles.FirstOrDefault() =="Admin")
                        System.Web.HttpContext.Current.Session["UserType"] = "Admin";
                    else
                        System.Web.HttpContext.Current.Session["UserType"] = roles;
        ...
        public async Task<ActionResult> Register(RegisterViewModel model, string UserType)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    result = UserManager.AddToRole(user.Id, UserType);
